...
def main():
    ...
    # Create a Label under the Black_Jack_logo(Dealer stands on 17)
    label_dealer_text = Label(root, foreground='#1a0000', text='DEALER STANDS ON 17')
